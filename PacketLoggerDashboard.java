...
public class PacketLoggerDashboard extends JFrame {
    ...
    browseButton.addActionListener((java.awt.event.ActionEvent ev) -> {
        ...
        int res = chooser.showOpenDialog(PacketLoggerDashboard.this);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PacketLoggerDashboard dashboard = new PacketLoggerDashboard();
    ...
    private static class PacketCaptureService {
        ...
        private final PacketLoggerDashboard dashboard;
        private final Map<String, Integer> ipPacketCounts = new HashMap<>();
        private int totalPackets = 0;
        private long lastTimestamp = System.currentTimeMillis();

        public PacketCaptureService(PacketLoggerDashboard dashboard) {
